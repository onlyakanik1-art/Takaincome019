...
<body>
    ...
    <script>
        ...
        const BOT_TOKEN = "8444131317:AAGGXs_wp9C-68gv20Hm84YAzB7u0HQcIyQ"; // আপনার বট টোকেন
        const ADMIN_CHAT_ID = "7797380497"; // আপনার টেলিগ্রাম চ্যাট আইডি
        ...
        function checkAdReady() {
            if (typeof window.show_10555433 !== 'function') {
